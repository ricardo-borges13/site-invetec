  ...
  return (
    ...
    >
      <S.Container>
        ...
        <S.Section>
          <MotionReveal>
            <h2>Seu site hoje traz clientes… ou só ocupa espaço?</h2>
            <p>
          ...
          <MotionReveal>
            ...
            <S.Grid>
              ...
              <S.Card>
                ...
                <p>Cadastro e estruturação para melhorar visibilidade local.</p>
              </S.Card>
...
<S.Section>
  <MotionReveal>
    <h2>Depois do site, o próximo passo é crescer sua presença digital</h2>

    <p>
      Com um site bem estruturado, sua empresa passa a ter uma base sólida
      para gerar contatos e transmitir confiança.
    </p>
    ...
    <ul>
      <li>✔ Redes sociais organizadas (Instagram, Facebook, LinkedIn)</li>
    ...
    <p>
      Esse é um processo natural: primeiro estruturamos o site, depois ampliamos sua presença e alcance.
    </p>
  </MotionReveal>
</S.Section>
    </PageHeroSection>
