...
const CaseDatron = lazy(() =>
  import('@/pages/CaseDatron/CaseDatron').then(module => ({
    default: module.CaseDatron,
  }))
);
const CaseJPM = lazy(() =>
  import('@/pages/CaseJPM/CaseJPM').then(module => ({
    default: module.CaseJPM,
  }))
);
const Cases = lazy(() =>
...
const Contato = lazy(() =>
  import('@/pages/Contato/Contato').then(module => ({
    default: module.Contato,
  }))
);
const ERP = lazy(() =>
  import('@/pages/ERP/ERP').then(module => ({ default: module.ERP }))
);
const Site = lazy(() =>
  import('@/pages/Site/Site').then(module => ({ default: module.Site }))
);
const Sobre = lazy(() =>
  import('@/pages/Sobre/Sobre').then(module => ({ default: module.Sobre }))
);
const SuporteTI = lazy(() =>
  import('@/pages/SuporteTI/SuporteTI').then(module => ({
    default: module.SuporteTI,
  }))
);
const Ecommerce = lazy(() =>
  import('@/pages/Ecommerce/Ecommerce').then(module => ({
...
const Bling = lazy(() =>
  import('@/pages/Bling/Bling').then(module => ({ default: module.Bling }))
);
const FerramentasUteis = lazy(() =>
  import('@/pages/FerramentasUteis/FerramentasUteis').then(module => ({
    default: module.FerramentasUteis,
  }))
);
const ProRata = lazy(() =>
  import('@/pages/ProRata/ProRata').then(module => ({
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/servicos/ferramentas-uteis/calculadora-de-datas',
        element: <CalculadoraData />,
      },
